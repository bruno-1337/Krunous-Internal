...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    else if (*v)
    {
		...
		// gradient
		//window->DrawList->AddRectFilledMultiColor(check_bb.Min + ImVec2(pad, pad), check_bb.Max - ImVec2(pad, pad), GetColorU32(ImVec4(0.0f, 0.0f, 0.0f, 0.05f)), GetColorU32(ImVec4(0.0f, 0.0f, 0.0f, 0.05f)), GetColorU32(ImVec4(0.0f, 0.0f, 0.0f, 0.40f)), GetColorU32(ImVec4(0.0f, 0.0f, 0.0f, 0.40f)));
...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags)
{
	...
	PushStyleColor(ImGuiCol_Border, GetColorU32(hovered ? ImGuiCol_ControlBgHovered : ImGuiCol_Border));
...
bool ImGui::SliderBehaviorT(const ImRect& bb, ImGuiID id, ImGuiDataType data_type, TYPE* v, const TYPE v_min, const TYPE v_max, const char* format, float power, ImGuiSliderFlags flags, ImRect* out_grab_bb)
{
    ...
    else
    {
        ...
        if (axis == ImGuiAxis_X)
            ...
            *out_grab_bb = ImRect(bb.Min.x + grab_padding, grab_pos - grab_sz * 0.5f, bb.Max.x - grab_padding, slider_usable_pos_min + grab_sz * 0.5f);
    }
...
bool ImGui::InputTextEx(const char* label, const char* hint, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* callback_user_data)
{
    ...
    const ImRect frame_bb(window->DC.CursorPos + ImVec2(label_size.x > 0.0f ? style.ItemInnerSpacing.x + h : 0.0f, label_size.x > 0.0f ? label_size.y : 0.0f), window->DC.CursorPos + frame_size + ImVec2(label_size.x > 0.0f ? style.ItemInnerSpacing.x + h : 0.0f, label_size.x > 0.0f ? label_size.y : 0.0f));
    const ImRect total_bb(window->DC.CursorPos, frame_bb.Min + total_size);
...
bool ImGui::Selectable(const char* label, bool selected, ImGuiSelectableFlags flags, const ImVec2& size_arg)
{
    ...
    if (hovered || selected)
    {
		...
		// gradient
		window->DrawList->AddRectFilledMultiColor(bb.Min, bb.Max, GetColorU32(ImVec4(0.0f, 0.0f, 0.0f, 0.05f)), GetColorU32(ImVec4(0.0f, 0.0f, 0.0f, 0.05f)), GetColorU32(ImVec4(0.0f, 0.0f, 0.0f, 0.30f)), GetColorU32(ImVec4(0.0f, 0.0f, 0.0f, 0.30f)));
...
namespace ImGui
{
	...
	static float            TabBarCalcMaxTabWidth(int iTabsCount);
...
static void ImGui::TabBarLayout(ImGuiTabBar* tab_bar)
{
    ...
    {
        const float tab_max_width = TabBarCalcMaxTabWidth(tab_bar->Tabs.Size);
        for (int tab_n = 0; tab_n < tab_bar->Tabs.Size; tab_n++)
        {
            ImGuiTabItem* tab = &tab_bar->Tabs[tab_n];
			// modified by EsTruPo
